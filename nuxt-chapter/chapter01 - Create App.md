...
``Nuxt`` គឺជា Framework មួយដែលបង្កើតឡើងលើ Vue 3 ដើម្បីជួយអភិវឌ្ឍគេហទំព័រ និង Web Application ឲ្យមានល្បឿនលឿន ងាយស្រួល និងមានប្រសិទ្ធភាព។ Nuxt គាំទ្ររបៀបបង្ហាញទំព័រច្រើនប្រភេទ ដូចជា៖
...
Nuxt ក៏មានឯកសារណែនាំផ្លូវការ ដែលពន្យល់ពីការប្រើប្រាស់ និងរចនាសម្ព័ន្ធគម្រោងយ៉ាងលម្អិត នៅគេហទំព័រ https://nuxt.com/
### Create Project
